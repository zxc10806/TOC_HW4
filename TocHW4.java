...
public class TocHW4{
		...
		public static  String GetRoadName(String Input)
		{
				...
				for(i=0;i<Input.length();i++)
						if(Input.charAt(i)=='路'||Input.charAt(i)=='街'||Input.charAt(i)=='巷')
						{
		...
		public static  void main(String [] args)
		{
				...
				try{
						...
						for(int i = 0;i< rootobj.length();i++)
						{
								...
								if(jloc.contains("路")||jloc.contains("街")||jloc.contains("巷"))
								{
						...
						for(int i = 0;i<maxM.size();i++)
						{
								...
								System.out.println(maxM.get(i)+" Max:"+tmp.maxprice+" Min:"+tmp.minprice);
						}
